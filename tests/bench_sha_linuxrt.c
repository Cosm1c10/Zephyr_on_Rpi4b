...
int main(void) {
    ...
    const unsigned long long ref_min    = 1415;
    const unsigned long long ref_max    = 4267;
    const unsigned long long ref_avg    = 1475;
    const unsigned long long ref_jitter = 2851;
